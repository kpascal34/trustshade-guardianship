    ...
    >
      <div className="container mx-auto px-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link
            to="/"
            className="text-gray-700 hover:text-fortis-light-blue font-medium transition-colors"
          >
            Home
          </Link>
          <Link
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white w-full py-4 shadow-md animate-fade-in">
          <div className="container mx-auto px-4 flex flex-col space-y-4">
            <Link
              to="/"
              className="text-gray-700 hover:text-fortis-light-blue font-medium py-2 transition-colors"
              onClick={closeMenu}
            >
              Home
            </Link>
            ...
            <Button 
              asChild 
              className="bg-fortis-light-blue hover:bg-fortis-dark-blue w-full mt-2"
              onClick={closeMenu}
            >
              <Link to="/contact">Get a Quote</Link>
            </Button>
