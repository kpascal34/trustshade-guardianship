  ...
  return <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <img alt="Security guard at venue entry" src="/lovable-uploads/337243a0-d803-45d9-80f5-197f22654359.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
          <div>
            <img alt="Security guard at gated venue" src="/lovable-uploads/9af25a0f-05e0-4ecc-9585-7c8f91490297.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
          <div>
            <img alt="Security guard at venue entrance" src="/lovable-uploads/10e86f82-63d2-409b-a59b-e8fd392779e5.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
          <div>
            <img alt="Event security guard" src="/lovable-uploads/35720d8f-0822-49a9-85e5-cc304a038298.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
          <div>
            <img alt="Security staff at boxing event" src="/lovable-uploads/53d91845-5bd0-443b-b4df-262e7d65185b.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
          <div>
            <img alt="Security guard at venue perimeter" src="/lovable-uploads/96449b0d-cc0b-4f46-9807-52a3de0fecef.png" className="w-full h-auto rounded-lg shadow-md object-cover aspect-square" />
          </div>
        </div>
      </section>
